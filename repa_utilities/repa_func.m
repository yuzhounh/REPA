...
starting_dir = para.starting_dir;
...
repa_check_directories(working_dir, starting_dir);

% software versions
repa_requirements(working_dir);
...
if strcmp(starting_dir, 'FunRaw')
    ...
    Cfg.StartingDirName = starting_dir;

...
tic;
fprintf('Applying band-pass filter...\n');
ADataDir = repa_unique_slash(ADataDir);
fprintf('Applying ideal rectangular filter to "%s"', ADataDir);
...
fprintf('Band Pass Filter working. \n');
...
fprintf('Saving filtered images. \n');
...
fprintf('Band pass filter finished. \nElapsed time: %0.2f seconds.\n', toc);

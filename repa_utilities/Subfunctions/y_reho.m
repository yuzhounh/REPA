...
% -------------------------------------------------------------------------
fprintf('Reading these 3D EPI functional images.');
...
AMaskFilename = repa_unique_slash(AMaskFilename);
fprintf('Load mask "%s".\n', AMaskFilename);
...
fprintf('Regional Homogeneity computation completed. \nElapsed time: %0.2f seconds.\n\n\n\n', theElapsedTime);

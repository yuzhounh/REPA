function [Error]=DPARSFA_with_GSR_serial(Cfg)
% FORMAT Error]=DPARSFA_run_serial_GSR(Cfg)
...
% Modified by Jing Wang, 09/11/2024
...
Cfg.StartingDirName = [StartingDirName,'global'];  % modified
...
SubjectID = Cfg.SubjectID{1,1};
configFileName = fullfile(Cfg.WorkingDir,'configurations',sprintf('%s_DPARSFA_with_GSR.mat',SubjectID));
save(configFileName,'Cfg');

fprintf('Running DPARSFA with GSR...\n\n')
[Error]=DPARSFA_serial(Cfg);
fprintf('Running DPARSFA with GSR is completed.\n\n')